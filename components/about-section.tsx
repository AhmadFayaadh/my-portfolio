      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <p className="text-lg text-gray-600 leading-relaxed mb-6">
            I'm passionate about cybersecurity and front-end development. I have experience in CTF competitions, ethical
            hacking, and UI/UX design. I love building clean, user-centered digital experiences that make a difference
            in people's lives.
          </p>
